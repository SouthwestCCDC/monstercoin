...
uint256 hashGenesisBlock("0x8634b1c1ee06644609930aa3a63d556d864c1e53be8fa3e281ed30badaaad4ce");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // monsterCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "monsterCoin Signed Message:\n";
...
{
    // monsterCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // monsterCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // monsterCoin: 3.5 days
static const int64 nTargetSpacing = 150; // monsterCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // monsterCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // monsterCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // monsterCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0e4d7d4a336560fe170fb015a2f199ff672185fa8c5c02c957a097e3df65066c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("fa82ccf6669b441fad3dd5b9c5a182394c41db2b8d029bb81bb552e3bdc0f33682e628c59e2e70dc888fff5883788cee913965766934a65358eebd111123af23a5") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1583292432;
        block.nBits    = 504365644;
        block.nNonce   = 4195826001;

        if (fTestNet)
        {
            block.nTime    = 1583292432;
            block.nNonce   = 319077410;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x0e2b0381df60d8c88ddfa23f942f4a8e8fca747b45132bb768c8009e0a54f401"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // monsterCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("monsterCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("monsterCoinMiner : ProcessBlock, block not accepted");
    }
